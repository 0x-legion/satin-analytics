...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://satin.exchange/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://satin.exchange/#/swap?inputCurrency=${token0Address === '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270' ? 'MATIC' : token0Address
...
export function getDAppLink(linkVariable) {
  let baseUniswapUrl = 'https://satin.exchange/#/uni'
  if (!linkVariable) {
